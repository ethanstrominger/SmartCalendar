...
The Smart Calendar app queries event calendars on the web based on criteria that you specify and consolidates the events into one of your Google calendars based on criteria you specify. You are notified when new events match your criteria and when the date, time, or location of already synchorinized events changed.
...
This section has moved here: https://facebook.github.io/create-react-app/docs/troubleshooting#npm-run-build-fails-to-minify
>>>>>>> 136194e558845684f11e2558f8ce2e48fa6ecfa9
