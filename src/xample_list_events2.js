...
async function authorize(credentials) {
    ...
    try {
        ...
        try {
            ...
            console.log("Error in call to getAccessToken: ", e);
            return;
        }
        // If getAccessToken successful, continues here
    }
...
async function getAccessToken(oAuth2Client) {
    ...
    const token = await getTokenAndCreateTokenFile(oAuth2Client, code);
    return token;
}

function getTokenAndCreateTokenFile(oAuth2Client, code) {
